...
class FileValidator(object):
    ...
    extension_message = _("Extensión '%(extension)s' not permitida. Extensiones permitidas: '%(allowed_extensions)s.'")
    ...
    max_size_message = _('El archivo actual %(size)s, es muy pesado! El tamaño máximo es %(allowed_size)s.')
